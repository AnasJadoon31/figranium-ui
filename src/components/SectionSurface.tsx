    ...
    >
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute inset-0 bg-linear-to-br from-white/10 via-transparent to-black/80" />
          ...
          <div className="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-zinc-300/40 to-transparent" />
          <div className="absolute inset-x-12 bottom-0 h-px bg-linear-to-r from-transparent via-zinc-800/60 to-transparent" />
        </div>
