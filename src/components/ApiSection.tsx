    ...
    <section className="py-32 px-6 max-w-5xl mx-auto relative z-10">
      <div className="bg-[#050505] border border-white/10 rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            <div className="bg-[#0A0A0A] border border-white/10 rounded-xl shadow-2xl overflow-hidden font-mono text-sm">
              ...
              <div className="p-6 overflow-x-auto">
                <pre className="text-zinc-400 leading-loose">
                  <span className="text-blue-400">curl</span> <span className="text-purple-400">-X</span> POST <span className="text-emerald-400">"http://localhost:11345/tasks/:id/api"</span> \
                  <br />
                  {'  '}<span className="text-purple-400">-H</span> <span className="text-emerald-400">"x-api-key: dpl_9d2f..."</span> \
                  <br />
                  {'  '}<span className="text-purple-400">-d</span> <span className="text-emerald-400">'{"{"}<span className="text-blue-300">"target_url"</span>: <span className="text-emerald-400">"https://example.com"</span>{"}"}'</span>
                </pre>
              </div>
            </div>
          </motion.div>
